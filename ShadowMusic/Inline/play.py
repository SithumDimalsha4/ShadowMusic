...
def url_markup(videoid, duration, user_id, query, query_type):
    buttons = [
        [
            ...
            InlineKeyboardButton(text="▶️Play Now", callback_data=f"ShadowMusic {videoid}|{duration}|{user_id}"),
        ...
        [
            ...
            InlineKeyboardButton(text="✖️ Close Search", callback_data=f"forceclose {query}|{user_id}"),
        ],
    ]
    return buttons
